...
**Well watered plants have a much larger range of total biomass than drough stressed plants.  Overall, the Well watered plants have a larger biomass.  This makes sense based on the biology of plants**
...
**Specific leaf area seems to have not much effect on the total biomass. Statistically they have a moderate correlation (Check correlation!).**
...
Out of the four models we have tried, the best model is the one that includes **All three predictors: SLA, Species and water treatment**  
...
**reference for water_treatment:** **water_treatment**  
**reference for species_name:** **Species_NameAcispon Glaber**  

Interpret the model estimates for the:  

- intercept: **mass of acmispon glaber in drought stressed treatmenr when SLA = 0**  
- SLA slope: **across drought treamenmts and species, with each 1 unit increase in SLA (mm^2^/dry mass leaf), we expect an increase in total mass of - 0.00025 WHICH MEANS WITH THE ESTIMATE AND STANDARD ERROR THER IS NO EFFECT OF SLA ON TOTAL MASS**  
- well watered estimate: **Across species and SLA well watered plants tend to be 0.12 +- ( figure out +- in latex) 0.12 grams heavier than drought stressed plants**    
